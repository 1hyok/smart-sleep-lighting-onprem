...
> ☁️ **클라우드 마이그레이션(프로젝트 5)**: 본 온프레미스 구조의 AWS 전환 산출물·명세는
> [`aws/`](aws/) 디렉터리에 있습니다. 통합 인수인계서는 [`aws/HANDOVER-cloud.md`](aws/HANDOVER-cloud.md),
> 레이어별 명세는 [`aws/docs/`](aws/docs/) 참조. (아래는 기존 온프레미스 인수인계서)
